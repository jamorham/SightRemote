...
public class SlidingWindowConstraintTest {
    ...
    @Test
    public void test_SlidingWindowConstraint1() throws Exception {
    ...
    // test json general
    @Test
    public void test_SlidingWindowConstraint_json1() throws Exception {
    ...
    // test json general
    @Test
    public void test_SlidingWindowConstraint_json2() throws Exception {
    ...
    // test large failure
    @Test
    public void test_SlidingWindowConstraint2() throws Exception {
    ...
    @Test
    public void test_SlidingWindowConstraint3() throws Exception {
    ...
    @Test
    public void test_SlidingWindowConstraint4() throws Exception {
        SlidingWindowConstraint sw = null;
        // test persisting data
        sw = new SlidingWindowConstraint(0.5, 60 * 60 * 1000, "max_bolus_per_hour_persist", true, RuntimeEnvironment.application);
    ...
    @Test
    public void test_SlidingWindowConstraint5() throws Exception {
        SlidingWindowConstraint sw = null;
        // test persisting data zero size
        sw = new SlidingWindowConstraint(0.0, 60 * 60 * 1000, "max_bolus_per_hour_persist2", true, RuntimeEnvironment.application);
        assertWithMessage("Initial persistent data is empty").that(sw.testSizeOfStorage()).isEqualTo(0);
